...
const Button = ({ children, variant = 'primary', onClick, className = '' }) => {
    const baseStyles = "px-6 py-3.5 rounded-xl text-base font-semibold w-full relative transition-all duration-200 flex justify-center items-center border-none cursor-pointer active:scale-95";
